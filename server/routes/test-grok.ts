...
export const testGrokAPI: RequestHandler = async (req, res) => {
  ...
  console.log("[TEST GROK] API Key length:", GROK_API_KEY ? GROK_API_KEY.length : 0);
  ...
  try {
    ...
    console.log("[TEST GROK] Response body (first 500 chars):", responseText.substring(0, 500));
