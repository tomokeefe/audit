...
```typescript
// Server weights
[0.18, 0.13, 0.13, 0.13, 0.09, 0.09, 0.05, 0.05, 0.10, 0.05]

// Netlify demo weights (INCONSISTENT)  
[0.20, 0.15, 0.15, 0.15, 0.10, 0.10, 0.05, 0.10, 0.05, 0.05]
```
...
export const SECTION_WEIGHTS_ARRAY = [
  ...
  0.10, // Conversion Optimization - Direct revenue impact
...
export function cacheScore(websiteSignature, scores, overallScore, evidence, methodology) {
