    ...
    <div className={`flex items-center justify-center p-6 ${className}`}>
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>{message || config.defaultMessage}</CardDescription>
        </CardHeader>
...
export const ValidationError: React.FC<Omit<ErrorStateProps, "type">> = (
  props,
...
export const useErrorHandler = () => {
  ...
  const getErrorType = React.useCallback(
    (error: Error | null): ErrorStateProps["type"] => {
